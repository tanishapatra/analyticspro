...
const NavigationBar = () => {
  ...
  return (
    <>
      ...
      {/* 🔥 Success Popup */}
      {uploadMessage && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[9999] bg-green-500 text-white px-5 py-3 rounded-xl shadow-2xl animate-bounce">
